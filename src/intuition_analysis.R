...
intuition_plr_lasso <- read.csv("./data/intuition_plr_lasso.csv")

## Non Orthogonal v.s Orthogonal

simulation_temp <- intuition_plr_lasso %>%
...
ggsave(
  "./reports/figures/intution-non-orthogonal-vs-orthogonal-lasso.pdf",
  width = 5, height = 5
)
...
ggsave(
  "./reports/figures/intution-full-sample-vs-split-sample-lasso.pdf",
  width = 5, height = 5
)
...
ggsave(
  "./reports/figures/intution-iv-type-vs-partialling-out-lasso.pdf",
  width = 5, height = 5
)
...
ggsave("./reports/figures/intution-ols-vs-dml-lasso.pdf", width = 5, height = 5)

# Radom Forest

intuition_plr_rf <- read.csv("./data/intuition_plr_rf.csv")

## Non Orthogonal v.s Orthogonal

simulation_temp <- intuition_plr_rf %>%
  select(seed, Non.Orthogonal, Split.Sample) %>%
  gather(key = Methods, value = theta, c(Non.Orthogonal, Split.Sample))
...
ggsave(
  "./reports/figures/intution-non-orthogonal-vs-orthogonal-rf.pdf",
  width = 5, height = 5
)
...
ggsave(
  "./reports/figures/intution-full-sample-vs-split-sample-rf.pdf",
  width = 5, height = 5
)
...
ggsave(
  "./reports/figures/intution-iv-type-vs-partialling-out-rf.pdf",
  width = 5, height = 5
)
...
ggsave(
  "./reports/figures/intution-ols-vs-dml-rf.pdf",
  width = 5, height = 5
)